...
// Hinka: on startup load spork values from previous session if they exist in the sporkDB
void LoadSporksFromDB()
{
    for (int i = SPORK_STHinka; i <= SPORK_END; ++i) {
...
int64_t GetSporkValue(int nSporkID)
{
	...
	if (nSporkID == SPORK_16_ZEROCOIN_MAINTENANCE_MODE)
