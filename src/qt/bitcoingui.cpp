                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hinka Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hinka address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hinka: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHinka"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hinka Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hinka Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hinka"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hinka addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hinka addresses"));
	...
	*/
    ...
    openAction->setStatusTip(tr("Open a Hinka: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hinka Core help message to get a list with possible Hinka command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hinka Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hinka network", "", count));
}
...
{
    QString strTitle = tr("Hinka Core"); // default title
