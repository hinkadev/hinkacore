                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Hinka from zHinka"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zHinka"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zHinka));
...
// Cover scroll bar width with spacing
	...
	//this->setStyleSheet("color:black; background-color: black; selection-background-color: white; selection-color: black");
	view->setStyleSheet("selection-background-color: pink");
	this->setStyleSheet("selection-background-color: yellow");
