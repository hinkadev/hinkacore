...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hinka features */
        {"hinka", "masternode", &masternode, true, true, false},
        {"hinka", "listmasternodes", &listmasternodes, true, true, false},
        {"hinka", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hinka", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hinka", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hinka", "masternodedebug", &masternodedebug, true, true, false},
        {"hinka", "startmasternode", &startmasternode, true, true, false},
        {"hinka", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hinka", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hinka", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hinka", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hinka", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hinka", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hinka", "mnbudget", &mnbudget, true, true, false},
        {"hinka", "preparebudget", &preparebudget, true, true, false},
        {"hinka", "submitbudget", &submitbudget, true, true, false},
        {"hinka", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hinka", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hinka", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hinka", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hinka", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hinka", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hinka", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hinka", "checkbudgets", &checkbudgets, true, true, false},
        {"hinka", "mnsync", &mnsync, true, true, false},
        {"hinka", "spork", &spork, true, true, false},
        {"hinka", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hinka", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hinkad, or the -server option to hinka-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hinka-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23000/\n";
}
