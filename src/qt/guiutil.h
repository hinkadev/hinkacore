...
/** Utility functions used by the Hinka Qt UI.
 */
namespace GUIUtil
{
...
// Render Hinka addresses in monospace font
...
// Parse "hinka:" URI into recipient object, return true on successful parsing
