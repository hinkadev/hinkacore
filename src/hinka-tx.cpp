...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hinka Core hinka-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hinka-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hinka transaction") + "\n" +
                               "  hinka-tx [options] -create [commands]   " + _("Create hex-encoded hinka transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hinka transaction
