...
In order to support loading of multiple wallets in hinka-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hinka.cpp.
...
Changes to hinka.cpp
----------------------
hinka.cpp is the entry point into hinka-qt, and as such, will require some minor modifications to provide hooks for
