...
RESOURCES += src/qt/hinka.qrc src/qt/hinka_locale.qrc

TRANSLATIONS += src/qt/locale/hinka_bg.ts \
                src/qt/locale/hinka_de.ts \
                src/qt/locale/hinka_en.ts \
                src/qt/locale/hinka_es.ts \
                src/qt/locale/hinka_fi.ts \
                src/qt/locale/hinka_fr.ts \
                src/qt/locale/hinka_it.ts \
                src/qt/locale/hinka_ja.ts \
                src/qt/locale/hinka_pl.ts \
                src/qt/locale/hinka_pt.ts \
                src/qt/locale/hinka_ru.ts \
                src/qt/locale/hinka_sk.ts \
                src/qt/locale/hinka_sv.ts \
                src/qt/locale/hinka_vi.ts \
                src/qt/locale/hinka_zh_CN.ts \
                src/qt/locale/hinka_zh_TW.ts
